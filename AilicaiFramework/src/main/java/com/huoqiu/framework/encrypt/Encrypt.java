...
public class Encrypt {
    ...
    public static String decryptKey(String requestBody, String timestamp, String packageName) {
        return native_decrypt(requestBody.getBytes(), timestamp.getBytes(), packageName.getBytes());
    }
