...
/*  first round encrypt/decrypt key */
char ROUND1_KEY[] = "huoqiu_not_manyi_key";
/* second round encrypt/decrypt key */
char ROUND2_KEY[] = "huoqiu_not_manyi_key_";

/* App package name, keep consistent with AandroidManifest.xml package name */
...
/* decrypt the cipher then split the result to 3 segments */
...
/* Concatenate json body, timestamp and secret to generate the result MD5 */
