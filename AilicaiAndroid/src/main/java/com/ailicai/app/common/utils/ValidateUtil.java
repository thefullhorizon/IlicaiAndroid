...
public class ValidateUtil {
    ...
    public static final String RULE_AUTHCODE_SIMPLE_FOUR = "^[0-9]{4}$";
    ...
    public static boolean isValidAuthCode(String postalCode) {
        return isValidString(postalCode, RULE_AUTHCODE_SIMPLE_FOUR);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isValidMobile("12312312311"));
