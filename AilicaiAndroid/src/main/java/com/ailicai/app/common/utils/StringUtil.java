...
public class StringUtil {
    ...
    public static String trimTelNum(String telNum) {
        ...
        String ippfx4 = "";
        if (telNum.length() >= 6) {
            ippfx6 = substring(telNum, 0, 6);
        }
        if (telNum.length() >= 5) {
            ippfx5 = substring(telNum, 0, 5);
        }

        if (telNum.length() >= 4) {
            ippfx4 = substring(telNum, 0, 4);
        }
        ...
        if (telNum.length() >= 4 && substring(telNum, 0, 4).equals("0086"))
            telNum = substring(telNum, 4);
        else if (telNum.length() >= 3 && substring(telNum, 0, 3).equals("+86"))
            telNum = substring(telNum, 3);
        else if (telNum.length() >= 5 && substring(telNum, 0, 5).equals("00186"))
            telNum = substring(telNum, 5);
