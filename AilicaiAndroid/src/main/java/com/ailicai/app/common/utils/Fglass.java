...
public class Fglass {
    ...
    public static void blur(View fromView, View toView, float radius, float scaleFactor) {
        ...
        Bitmap overlay = Bitmap.createBitmap((int) (fromView.getMeasuredWidth() / scaleFactor),
                (int) (fromView.getMeasuredHeight() / scaleFactor), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(overlay);
        canvas.translate(-fromView.getLeft() / scaleFactor, -fromView.getTop() / scaleFactor);
    ...
    public static Bitmap blur(View fromView, float radius, float scaleFactor) {
