...
public class UserPhoneValidateActivity extends BaseBindActivity {
    ...
    public int getLayout() {
        return R.layout.userphone_validate_activity_layout;
    }
    ...
    public void init(Bundle savedInstanceState) {
        ...
        mFragmentHelper.replace(MyIntent.setData(new Bundle(), dataMap), R.id.user_phone_validate_main, new UserPhoneValidateFragment());
    }
