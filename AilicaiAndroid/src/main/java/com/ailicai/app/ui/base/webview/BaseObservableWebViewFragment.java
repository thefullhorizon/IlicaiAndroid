...
public abstract class BaseObservableWebViewFragment extends BaseBindFragment {
    ...
    private BaseObservableWebViewLayout webViewLayout;

    @Override
    public void init(Bundle savedInstanceState) {
        super.init(savedInstanceState);
        webViewLayout = new BaseObservableWebViewLayout((BaseActivity) getActivity());
    ...
    protected void setTitleCanBack(final BaseObservableWebViewLayout.ITitleClickListener listener) {
        if (null != getWebViewLayout()) {
    ...
    protected void setIWebListener(BaseObservableWebViewLayout.IWebListener iWebListener) {
    ...
    public void setLoadingStyle(BaseObservableWebViewLayout.LoadingStyle loadingStyle) {
        if (null != getWebViewLayout()) {
    ...
    public BaseObservableWebViewLayout getWebViewLayout() {
