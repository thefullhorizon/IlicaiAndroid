...
public class Legend extends ComponentBase {
    ...
    /** the shape/form the legend colors are drawn in for every label*/
    private List<LegendForm> shapes = new ArrayList<>();
    ...
    public void addForm(LegendForm shape){
        shapes.add(shape);
    }

    public List<LegendForm> getForms() {
        return shapes;
    }
