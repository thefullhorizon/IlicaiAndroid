...
public class AHBottomNavigationItem {
	...
	public AHBottomNavigationItem(@StringRes int titleRes, @DrawableRes int drawableRes, @DrawableRes int drawableSelectedRes, @ColorRes int colorRes) {
		this.titleRes = titleRes;
		this.drawableRes = drawableRes;
		this.drawableSelectedRes = drawableSelectedRes;
	...
	public Drawable getDrawableSelected(Context context) {
		if (drawableSelectedRes != 0) {
			return ContextCompat.getDrawable(context, drawableSelectedRes);
		}
		return drawableSelected;
	}

	public void setDrawableSelected(@DrawableRes int drawableSelectedRes) {
		this.drawableSelectedRes = drawableSelectedRes;
