...
import com.ailicai.app.widget.mpchart.data.realm.base.RealmBarLineScatterCandleBubbleDataSet;
...
public class RealmBarDataSet<T extends RealmObject> extends RealmBarLineScatterCandleBubbleDataSet<T, BarEntry> implements IBarDataSet {
    ...
    /**
     * Sets labels for different values of bar-stacks, in model there are one.
     *
     * @param labels
     */
