...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    protected void drawCircles(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            for (int j = minx,
                ...
                LogUtil.i("duo","circlesBuffer[0] " +circlesBuffer[0] + " circlesBuffer[1] " + circlesBuffer[1]);
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (int i = 0; i < indices.length; i++) {
            ...
            float radius = Utils.convertDpToPixel(6);
            float halfsize = Utils.convertDpToPixel(4);

            mRenderPaint.setColor(Color.RED);
            mRenderPaint.setStyle(Paint.Style.FILL);
            c.drawCircle(pts[0], pts[1], radius, mRenderPaint);
            c.drawCircle(pts[0], pts[1], halfsize, mCirclePaintInner);
            ...
            LogUtil.i("duo", "pts[0] " + pts[0] + " pts[1] " + pts[1]);
        }
    }
