...
public class DragLayout extends ViewGroup {
    ...
    private OnNextPageListener nextPageListener; // 手指松开是否加载下一页的notifier
    private TextView tvDragText;//拖拽的TextView文案
    private int dragTextViewId;
    ...
    public void setDragTextViewId(int id) {
        this.dragTextViewId = id;
    }
     ...
     * 设置上拉文案
     */
    private void setPullUpText() {
        if (tvDragText == null) {
            tvDragText = (TextView) findViewById(dragTextViewId);
        }
        tvDragText.setText("向上拖动，查看更多");
    }
