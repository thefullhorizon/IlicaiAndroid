...
import com.ailicai.app.widget.mpchart.charts.PieChart;
...
public class PieChartRenderer extends DataRenderer {
    ...
    protected void drawDataSet(Canvas c, IPieDataSet dataSet) {
        ...
        for (int j = 0; j < entryCount; j++) {
            ...
            LogUtil.i("PieChart", " sliceAngle " + sliceAngle );
                ...
                if (!mChart.needsHighlight(e.getXIndex(),
                    ...
                    if (drawInnerArc &&
                        ...
                        if (accountForSliceSpacing) {
                            ...
                            LogUtil.i("pieChart","minSpacedRadius " +minSpacedRadius);
                        ...
                        if (sweepAngleOuter % 360f != 0.f) {
                            if (accountForSliceSpacing) {
                                ...
                                LogUtil.i("pieChart","minSpacedRadius " +sliceSpaceOffset);
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (int i = 0; i < indices.length; i++) {
            ...
            if (accountForSliceSpacing) {
                ...
                LogUtil.i("pieChart","sliceSpaceRadius " +sliceSpaceRadius);
            }
