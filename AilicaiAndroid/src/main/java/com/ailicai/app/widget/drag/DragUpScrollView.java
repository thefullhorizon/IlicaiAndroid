...
public class DragUpScrollView extends ScrollView {
    ...
    public DragUpScrollView(Context arg0) {
        this(arg0, null);
    }

    public DragUpScrollView(Context arg0, AttributeSet arg1) {
        this(arg0, arg1, 0);
    }

    public DragUpScrollView(Context arg0, AttributeSet arg1, int arg2) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            downY = ev.getRawY();
            needConsumeTouch = true; // 默认情况下，ScrollView内部的滚动优先，默认情况下由该listView去消费touch事件
            ...
            if (!needConsumeTouch) {
                ...
                // 允许拖动到顶部的上一页，而且又向上拖动了，就将touch事件交给父view
