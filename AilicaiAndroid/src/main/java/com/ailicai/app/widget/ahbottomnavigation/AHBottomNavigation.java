package com.ailicai.app.widget.ahbottomnavigation;
...
import com.ailicai.app.widget.ahbottomnavigation.notification.AHNotification;
import com.ailicai.app.widget.ahbottomnavigation.notification.AHNotificationHelper;
    ...
    private void createClassicItems(LinearLayout linearLayout) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            icon.setImageDrawable(AHHelper.getTintDrawable(
                    current ? items.get(i).getDrawable(context) : items.get(i).getDrawableSelected(context),
   ...
   /*         icon.setImageDrawable(AHHelper.getTintDrawable(items.get(i).getDrawable(context),
    ...
    private void createSmallItems(LinearLayout linearLayout) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            icon.setImageDrawable(AHHelper.getTintDrawable(currentItem == i?items.get(i).getDrawable(context):items.get(i).getDrawableSelected(context),
    ...
    private void updateItems(final int itemIndex, boolean useCallback) {
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            if (i == itemIndex) {
                ...
                AHHelper.updateDrawableColor(context, items.get(currentItem).getDrawableSelected(context)/*.getDrawable(context)*/, icon,
