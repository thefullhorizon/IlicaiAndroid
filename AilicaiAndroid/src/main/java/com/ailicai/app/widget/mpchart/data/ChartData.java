...
package com.ailicai.app.widget.mpchart.data;
...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
    ...
    public void calcMinMax(int start, int end) {
        ...
        if (mDataSets == null || mDataSets.size() < 1) {
            ...
            // in model there is only one axis, adjust the second axis
     ...
     * Search can be model sensitive or not. IMPORTANT: This method does
     * calculations at runtime, do not over-use in performance critical
     * situations.
     *
     * @param dataSets   the DataSet array to search
     * @param label
     * @param ignorecase if true, the search is not model-sensitive
     * @return
     */
    ...
    /**
     * Returns the DataSet object with the given label. Search can be model
