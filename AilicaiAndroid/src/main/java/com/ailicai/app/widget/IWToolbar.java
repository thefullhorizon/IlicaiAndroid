...
public class IWToolbar extends LinearLayout implements View.OnClickListener {
...
TextView titleMiddleTextView;
    ...
    public IWToolbar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initView() {
        ...
        View.inflate(getContext(), R.layout.iw_top_toolbar_layout_l, this);
    ...
    public void addCustomeViewToRightLayout(View rightView, OnClickListener onClickListener) {
